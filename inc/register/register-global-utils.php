...
if (!function_exists("pmc_get_checkbox_multiple")) {
	 ...
	 * or the $default_value passed (false) if the meta key doesn't exist.
	 */
	function pmc_get_checkbox_multiple(
		$meta_key = "",
		$post_id = "",
		$default_value = false
	) {
